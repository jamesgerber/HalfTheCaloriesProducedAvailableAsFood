...
for j=1:numel(ISOGroupList);
    ...
    DS.DietsPerHa2020Produced(j)=Production2020(j)/365/2700/Area2020group(j);
    DS.DietsPerHa2020Food(j)=Food2020group(j)/365/2700/Area2020group(j);
    ...
    DS.DietsPerHa2010Produced(j)=Production2010(j)/365/2700/Area2010group(j);
    DS.DietsPerHa2010Food(j)=Food2010group(j)/365/2700/Area2010group(j);
...
sov2csv(DS,'Table2AllCountries.csv');
