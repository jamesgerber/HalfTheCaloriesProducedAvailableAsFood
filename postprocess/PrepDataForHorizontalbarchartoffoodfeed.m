...
% now make a csv version

fid=fopen(['intermediatedatafiles/horizontalbarchartdata' int2str(YYYY) '.csv'],'w');
BarData1=[DirectFoodCaloriesSum IndirectFoodCaloriesSum (FeedCaloriesSum-IndirectFoodCaloriesSum) NonFoodCaloriesSum];
BarData2=[DirectFoodCaloriesSum BeefCalsSum PorkCalsSum ChixCalsSum EggsCalsSum MilkCalsSum BeefCalsLostSum PorkCalsLostSum ChixCalsLostSum EggsCalsLostSum MilkCalsLostSum NonFoodCaloriesSum];

fprintf(fid,'%f,%s,\n', DirectFoodCaloriesSum ,'DirectFoodCaloriesSum');
fprintf(fid,'%f,%s,\n',  FeedCaloriesSum,'FeedCaloriesSum');
fprintf(fid,'%f,%s,\n',  NonFoodCaloriesSum,'NonFoodCaloriesSum');
fprintf(fid,'%f,%s,\n',  IndirectFoodCaloriesSum,'IndirectFoodCaloriesSum');
fprintf(fid,'%f,%s,\n',  BeefCalsSum,'BeefCalsSum');
fprintf(fid,'%f,%s,\n',  PorkCalsSum,'PorkCalsSum');
fprintf(fid,'%f,%s,\n',  ChixCalsSum,'ChixCalsSum');
fprintf(fid,'%f,%s,\n',  EggsCalsSum,'EggsCalsSum');
fprintf(fid,'%f,%s,\n',  MilkCalsSum,'MilkCalsSum');
fprintf(fid,'%f,%s,\n',  BeefCalsLostSum,'BeefCalsLostSum');
fprintf(fid,'%f,%s,\n',  PorkCalsLostSum,'PorkCalsLostSum');
fprintf(fid,'%f,%s,\n',  ChixCalsLostSum,'ChixCalsLostSum');
fprintf(fid,'%f,%s,\n',  EggsCalsLostSum,'EggsCalsLostSum');
fprintf(fid,'%f,%s,\n',  MilkCalsLostSum,'MilkCalsLostSum');
