...
anyone running these codes will have to undertake two things:
...
(2) There is a file named HalfCaloriesLocalEnvironment.m - It's in .gitignore so you can change it and git won't try to track changes.    Here's what it looks like for me: 
...
I'm available to help answer quesions on how to do this (jgerber68@gmail.com)